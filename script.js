const UI_TEXTS = {
    ...
    'en': { welcome: 'Ho-ho-ho! I am Santa Claus. What is your name?', typing: 'Santa is recording...', error: 'The reindeer are stuck!' },
    'fr': { welcome: 'Je suis le Père Noël. Quel est ton nom?', typing: 'Le Père Noël écrit...', error: 'Erreur!' },
    'de': { welcome: 'Ich bin der Weihnachtsmann. Как тебя зовут?', typing: 'Schreibt...', error: 'Fehler!' },
    'es': { welcome: 'Soy Papá Noel. ¿Cómo te llamas?', typing: 'Escribiendo...', error: 'Error!' }
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.getElementById('reports-container')) {
        ...
        document.getElementById('reports-container').innerHTML = reports.map(r => `
            <div style="background:white; padding:15px; margin:10px; border-radius:12px; color:black; text-align:left; border-left: 5px solid red;">
